...
public class Operations {
	public static void addAttendence() {
		...
		String[] databaseEnroll = ConnectionOpratios.enrollsStudentsArray();
		System.out.print("ENTER ENROLLMENT NUMBER OF STUDENT :: ");
		String enroll=sc.nextLine();
		String temp1=enroll.replaceAll("\\s+","").toLowerCase();
		
		int f=0;
		for(int i=0;i<databaseEnroll.length;i++) {
			String temp=databaseEnroll[i].replaceAll("\\s+", "").toLowerCase();
		...
		if(ConnectionOpratios.InsertStudentToDB(at)) {
			...
			System.out.println("This enrollment number not present in our database...");
		}
	}
	...
	public static void totalClasses() {
		...
		if(classes.length>1) {
		  ...
		  System.out.println("*************************************************************************************************************************************************************************************************************");
			  ...
			  System.out.println("*************************************************************************************************************************************************************************************************************");
			  System.out.println("Total "+classes.length+" class added yet ");
			  System.out.println("*************************************************************************************************************************************************************************************************************");
