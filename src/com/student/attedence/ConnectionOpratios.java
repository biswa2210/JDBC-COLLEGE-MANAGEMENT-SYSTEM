...
public class ConnectionOpratios {
  ...
  public static void viewAll() {
	  try {
		  ...
		  System.out.println("*************************************************************************************************************************************************************************************************************");
		  System.out.printf("%-10s%-20s%-25s%-35s%-25s%-20s%-25s%-15s%-20s\n","ID","STUDENT ROLLS","STREAM","STUDENT NAME","YEAR","ENROLLMENT NO","CLASS ID","SECTION","DATE & TIME");
		  System.out.println("*************************************************************************************************************************************************************************************************************");
			if(rs.next()){ 
				do{
				System.out.printf("%-10s%-20s%-25s%-35s%-25s%-20s%-25s%-15s%-20s",rs.getString(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(9),rs.getString(8));
				System.out.println();
				}while(rs.next());
			}
			else{
  ...
  public static String[] findStudentForAttendence(String enroll) {
	  ...
	  try {
		  ...
		  System.out.println("*************************************************************************************************************************************************************************************************************");
		  System.out.printf("%-30s%-15s%-15s%-15s%-25s%-25s\n","NAME","YEAR","STREAM","ROLL","CLASS_ID","DATE & TIME");
		  System.out.println("*************************************************************************************************************************************************************************************************************");
		  int i=0;
			if(rs.next()){ 
				do{
				System.out.printf("%-30s%-15s%-15s%-15s%-25s%-25s",rs.getString(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6));
				System.out.println();
  ...
  public static String[] enrollsStudentsArray() {
	  String  stens[] = new String[0];
	  try {
		  Connection con=ConnectionEstablish.createRelation();
